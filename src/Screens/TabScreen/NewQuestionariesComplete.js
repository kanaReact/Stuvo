...
class NewQuestionariesComplete extends Component {
    constructor(props) {
        super(props);
        this.state = {
            data: [
    ...
    componentWillMount() {
        ...
        this.props.surveyList(this.props.AUTH, 'completed')
    }
                            ...
                            <FlatList
                                ...
                                renderItem={({ item, index }) => (
                                    <View style={{ borderBottomWidth: 1, borderBottomColor: '#E0E0E066' }}>
                                        <TouchableOpacity activeOpacity={0.6} onPress={() => this.props.navigation.navigate('CompletedQuestion', { weekData: item.list, week: item.Week })}>
...
export default connect(mapStateToProps, { surveyList })(NewQuestionariesComplete)