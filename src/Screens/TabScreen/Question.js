  ...
  get_pending_survey_count() {
    ...
    axios
      ...
      .then(async responseJson => {
        ...
        console.log('pending survey count:', JSON.stringify(responseJson.data));
                  ...
                  <TouchableOpacity
                    ...
                    <View
                      ...
                      <Text
                        ...
                        {item.text}{' '}
                        <Text style={{color: '#00AFF0'}}>
                          {item.text == 'Pending Surveys'
                            ? this.state.pendingCount != ''
                              ? '(' + this.state.pendingCount + ')'
                              : ''
                            : item.text == 'Completed Surveys'
