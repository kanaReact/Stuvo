    ...
    render() {
        return (
            <SafeAreaView style={styles.container}>
                ...
                <Text style={{ marginTop: 20, fontSize: 14, marginBottom: 12, fontFamily: 'Gotham-Medium', color: '#272727', lineHeight: 20, marginHorizontal: 24 }}>{this.state.welcomeData.description}</Text>
...
export default connect(mapStateToProps, { rememberMe, removerememberMe, handle_welcome })(WelcomeScreen)